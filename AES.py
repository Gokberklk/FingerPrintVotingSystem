...
def AESSec(mode, key, in_type, inputval):
    ...
    if in_type.lower() == 'text':
        blob_input = inputval.strip().encode('utf-8')
    elif in_type.lower() == 'image':
        # Code to handle image input
        blob_input = inputval.strip()  # Placeholder for image input handling
    else:
